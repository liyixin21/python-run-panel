      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14">
          ...
          <div class="flex items-center gap-3">
            ...
            <router-link
              to="/settings"
              class="flex items-center gap-1 px-2 py-1.5 text-xs rounded-lg text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
              title="面板设置"
            >
            ...
            <button
              @click="logout"
              class="flex items-center gap-1 px-2 py-1.5 text-xs rounded-lg text-gray-400 hover:text-red-500 dark:text-gray-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
              title="退出登录"
            >
